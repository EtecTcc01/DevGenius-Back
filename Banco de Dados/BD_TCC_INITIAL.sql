...
INSERT INTO tbl_user_group (id_group, id_user) VALUES (3, 1), (1, 1), (1, 2), (2, 2), (4, 2);
...
("MySQL", "MySQL é uma linguagem para gerenciar bancos de dados relacionais, permitindo consultas e manipulações.", 1), 
("Teste Grupo", "Testando grupo... Testando", 2);

INSERT INTO tbl_registration (id_user, id_course) VALUES (1, 1), (1, 2);

INSERT INTO tbl_stage (id_course, _name) VALUES (1, "HTML Básico 01"), (1, "HTML Básico 02"), (1, "HTML Intermediário 01"), 
(1, "HTML Avançado 01"), (2, "JAVASCRIPT Básico 01"), (2, "JAVASCRIPT Intermediário 01"), (3, "NODEJS Básico 01"), 
(3, "NODEJS Intermediário 01"), (4, "MYSQL Básico 01"), (4, "MYSQL Intermediário 01"), (5, "Teste 01"), (5, "Teste 02");
...
("JS01TEORY", "JavaScript é uma linguagem muito uilizada pelo mundo todo, sendo que alguns framworks foram criados a partir dele, como React, Vue e Angular.", 5), 
("HTML02TEORY", "Em HTML há duas tags essenciais para a formação do site, sendo elas <head> e <body>.", 2), 
("NODEJS01TEORY", "NodeJs é uma linguagem normalmente utilizada para a formação do Back-End do site.", 7),
("MYSQL01TEORY", "MySql é utilizado para a criação de um banco de dados, desde sua estrutura.", 9),
("TESTE01TEORY", "Testando grupo e suas teorias.", 11), ("TESTE02TEORY", "Testando grupo e suas teorias.", 11),
("TESTE03TEORY", "Testando grupo e suas teorias.", 12);
 
#TASKS BÁSICAS -----------------------------------------------------------------------------------------------------

# As tasks básica são, basicamente, um quiz, onde é adicionado uma tarefa e alternativas a serem escolhidas

INSERT INTO tbl_task (id_operation, _name, _text, _explanation, _exp, id_stage) VALUES (1, "HTML BÁSICO 01", "Qual tag que contém todo o código para a formação do site?", "Leia a Teoria HTML 01 para saber mais.", 5, 1),
(1, "JS BÁSICO 01", "Quais frameworks foram criados a partir do JavaScript", "Leia a Teoria JS 01 para saber mais.", 5, 5), 
(1, "HTML BÁSICO 02", "Quais tags são essencias para a formação do site em HTML?", "Leia a Teoria HTML 03 para saber mais.", 0, 2), 
(1, "NODEJS BÁSICO 01", "Node normalmente tende a ser utilizado para a formação do que, em um site?", "Leia a Teoria NODEJS 01 para saber mais.", 5, 7);
...
INSERT INTO tbl_task (id_operation, _name, _text, _explanation, _exp, id_stage) VALUES (2, "JS INTERMEDIÁRIO 01", "‼ (validacao == true) {\n    console.log(1)\n} ‼ {\n    console.log(0)\n}", "Leia a Teoria JS 02 para saber mais.", 5, 6), 
(2, "HTML INTERMEDIÁRIO 01", "<head>\n	<meta ‼='UTF-8'>\n<‼>", "Leia a Teoria HTML 02 para saber mais.", 5, 3), 
(2, "HTML INTERMEDIÁRIO 01", "<head>\n    <script src='js/script.js'><‼>\n    <‼ rel='stylesheet' ‼='css/style.css'>\n</head>", "Leia a Teoria HTML 04 para saber mais.", 0, 3), 
(2, "NODEJS INTERMEDIÁRIO 01", "‼ api = express();\napi.‼(cors());\napi.use(express.json());\n‼.use('/teste', routes);", "Leia a Teoria NODEJS 02 para saber mais.", 5, 8);
...
INSERT INTO tbl_task (id_operation, _name, _text, _explanation, _exp, id_stage) VALUES (3, "HTML Avançado 01", "Utilize das possibilidades dada para criar um código padrão <head> HTML.", "Leia a Teoria HTML 05 para saber mais.", 5, 4);
...
#TESTE
INSERT INTO tbl_task (id_operation, _name, _text, _explanation, _exp, id_stage) VALUES (1, "HTML BÁSICO 01.2", "Quais tags são usadas para 'linkar' o arquivo JavaScript e CSS com o HTML?", "Leia a Teoria HTML 01 para saber mais.", 5, 1);
