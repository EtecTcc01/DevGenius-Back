...
(2, "JAVASCRIPT 02"), (3, "NODEJS 01"), (3, "NODEJS 02"), (4, "MYSQL 01"), (4, "MYSQL 02"), 
(5, "Teste 01"), (5, "Teste 02");
...
(1, "JS BÁSICO 01", "Quais frameworks foram criados a partir do JavaScript", "Leia a Teoria JS 01 para saber mais.", 5, 3), 
(1, "HTML BÁSICO 02", "Quais tags são essencias para a formação do site em HTML?", "Leia a Teoria HTML 03 para saber mais.", 0, 2), 
(1, "NODEJS BÁSICO 01", "Node normalmente tende a ser utilizado para a formação do que, em um site?", "Leia a Teoria NODEJS 01 para saber mais.", 5, 5);
...
INSERT INTO tbl_task (id_operation, _name, _text, _explanation, _exp, id_stage) VALUES (3, "HTML Avançado 01", "Utilize das possibilidades dada para criar um código padrão <head> HTML.", "Leia a Teoria HTML 05 para saber mais.", 5, 1);
